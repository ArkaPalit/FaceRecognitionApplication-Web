...
def student(request):
    ...
    if request.method == 'POST':
        ...
        student=Student(reg_no=reg_no, name=name, course=course, school=school, dept=dept, roll_no=roll_no, university_mail=university_mail, mentors_name=mentors_name, photo=photo, parents_name=parents_name, parents_no=parents_no, parents_email=parents_email)
        student.save()
